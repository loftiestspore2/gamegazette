...
public class Board {
    ...
    private Board(Builder builder) {
        ...
        final Collection<board.Move> whiteLegalMoves= workLegalmoves(this.whitePieces);
        final Collection<board.Move> blackLegalMoves= workLegalmoves(this.blackPieces);
    ...
    private Collection<board.Move> workLegalmoves(Collection<Piece> pieces){

        final List<board.Move>legalMoves=new ArrayList<>();
